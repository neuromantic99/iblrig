...
class Session(BiasedChoiceWorldSession):
    ...
    def __init__(self, *args, session_template_id=0, **kwargs):
        ...
        trials_table = pd.read_parquet(
            Path(__file__).parent.joinpath("trials_fixtures.pqt")
        )
        self.trials_table = (
            trials_table.loc[trials_table["session_id"] == session_template_id]
            .reindex()
